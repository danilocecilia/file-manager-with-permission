...
namespace AspNetGroupBasedPermissions.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_RolesController : AspNetGroupBasedPermissions.Controllers.RolesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string message);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(string message)
        {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AspNetGroupBasedPermissions.Models.RoleViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(AspNetGroupBasedPermissions.Models.RoleViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AspNetGroupBasedPermissions.Models.EditRoleViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(AspNetGroupBasedPermissions.Models.EditRoleViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
